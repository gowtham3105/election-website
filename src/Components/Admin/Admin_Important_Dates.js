...
this.setState({ responseMessage: "" });
  ...
  render() {
    return (
      <div>
        <h1 className="admin-imp-h1" style={{ textAlign: "center" }}>Edit Important-Dates</h1>
        <hr />
        {this.state.show ? (
          <Container>
            <Row xs={1} md={2}>
            ...
            <Row>
              <Button className="admin-impdates-btn" onClick={this.sendDates} disabled={!this.state.changeBtnStatus}>
